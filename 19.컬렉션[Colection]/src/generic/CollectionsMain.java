...
public class CollectionsMain {
	public static void main(String[] args) {
		 ...
		 */
		Collections.sort(accountList, 
				new AccountBalanceAscendingComparator());
		System.out.println(">>잔고오름차순정렬후[Comparator]");
		for (Account account : accountList) {
			account.print();
		}
		Collections.sort(accountList, 
				new AccountBalanceDescendingComparator());
