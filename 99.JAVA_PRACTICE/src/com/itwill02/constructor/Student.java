...
public class Student {
	...
	public void headerPrint() {
		...
		System.out.printf("%s %4s %4s %2s %s %s %3s %s %s%n", "학번", "이름", "국어", "영어", "수학", "총점", "평균", "평점", "석차");
		System.out.printf("--------------------------------------------------%n");

	}

	public void print() {
		System.out.printf("%3d %5s %4d %4d %4d %5d %5.1f %3c %4d%n", this.no, this.name, this.kor, this.eng, this.math,
				this.tot, this.avg, this.grade, this.rank);
	}
	
	/*
	 * 이름변경 메쏘드(setter 메소드와 동일함)
	 */
