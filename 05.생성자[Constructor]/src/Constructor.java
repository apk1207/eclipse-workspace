...
public class Constructor {
	...
	/*
	 * 생성자메쏘드: 객체 생성후 최초로 단 한번 호출되는 메쏘드(????)
	 */
	public Constructor() {
		System.out.println("public Constructor() 기본생성자 호출:"+ this);
		/*
		 * 생성된 메쏘드 안에서는 생성된 객체의 self 참조변수 this 를 사용할 수 있다.
		 */
	}
	...
	public Constructor(int member1, int member2, String member3) {
		System.out.println("public Constructor(int member1, int member2, String member3) 생성자 호출");
