...
public class PreparedStatementMain {
	...
	public static void main(String[] args) throws Exception {
		...
		// insert - 03
		//insert into emp values(9000,'JUNG','MANAGER',7369,sysdate,3000.34,30,40);		
